...
function App() {
  ...
  const handleExcelImport = (scenario: NamedScenario) => {
    // Update the model input with the imported scenario's modelConfig
    updateInput(scenario.modelConfig);
  };
      ...
      case 'comparison':
        return (
          <PageTransition key="comparison">
            <ComparisonView currentInput={input} />
          </PageTransition>
        );
      case 'governance':
        return (
