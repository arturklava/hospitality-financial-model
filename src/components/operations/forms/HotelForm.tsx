          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <PercentageSlider
                ...
                onChange={(value) => onChange({ foodRevenuePctOfRooms: value })}
                min={0}
                max={1}
                step={0.01}
              />
              ...
              <PercentageSlider
                ...
                onChange={(value) => onChange({ beverageRevenuePctOfRooms: value })}
                min={0}
                max={1}
                step={0.01}
              />
              ...
              <PercentageSlider
                ...
                onChange={(value) => onChange({ otherRevenuePctOfRooms: value })}
                min={0}
                max={1}
                step={0.01}
              />
