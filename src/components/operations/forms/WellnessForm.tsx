...
interface WellnessFormProps {
  operation: WellnessConfig;
  onChange?: (updates: Partial<WellnessConfig>) => void;
  readOnly?: boolean;
}

export function WellnessForm({ operation, onChange, readOnly = false }: WellnessFormProps) {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              ...
              <InputGroup
                label="Avg Membership Fee (Annual)"
                required
