...
export function OperationEditor({ operation, onChange }: OperationEditorProps) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <SectionCard title="Revenue Drivers" defaultExpanded={true}>
      ...
      {/* Seasonality Section */}
      <SectionCard title="Seasonality" defaultExpanded={false}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <p style={{
            ...
            Adjust seasonal revenue multipliers for each month. Average should be 1.0 to maintain annual revenue targets.
          </p>
          <SeasonalityChart
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <p style={{
            ...
            Configure operational ramp-up parameters for stabilization period.
          </p>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1rem' }}>
            <InputGroup label="Stabilization Months" helperText="Number of months to reach full capacity">
              <input
                type="number"
                min="0"
                max="60"
            ...
            <InputGroup label="Start %" helperText="Initial capacity percentage (0-1)">
              <input
                type="number"
                min="0"
                max="1"
